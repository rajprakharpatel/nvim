...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "telescope-dap.nvim", "DAPInstall.nvim", "nvim-dap-ui", "nvim-dap-python" },
    commands = { "DAP" },
