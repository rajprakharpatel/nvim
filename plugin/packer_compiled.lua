...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-virtual-text", "telescope-dap.nvim", "DAPInstall.nvim", "nvim-dap-python" },
    commands = { "DAP" },
