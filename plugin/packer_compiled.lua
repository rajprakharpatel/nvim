...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "nvim-dap-ui", "DAPInstall.nvim", "telescope-dap.nvim", "nvim-dap-python" },
    commands = { "DAP" },
