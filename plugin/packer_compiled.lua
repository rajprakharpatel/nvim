...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "telescope-dap.nvim", "nvim-dap-python", "nvim-dap-virtual-text", "nvim-dap-ui", "DAPInstall.nvim" },
    commands = { "DAP" },
  ...
  ["nvim-neoclip.lua"] = {
    config = { "\27LJ\2\nƒ\1\0\0\5\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\2B\0\2\1K\0\1\0\tkeys\1\0\0\6i\1\0\0\1\0\3\npaste\n<m-p>\16pate_behind\n<m-k>\vselect\t<CR>\nsetup\fneoclip\frequire\0" },
    loaded = true,
  ...
  ["wandbox-vim"] = {
    commands = { "Wandbox", "Quickrun", "WandboxOptionList" },
    loaded = false,
    needs_bufread = false,
    path = "/home/rajp/.local/share/nvim/site/pack/packer/opt/wandbox-vim"
  },
  ["wandbox.nvim"] = {
    loaded = true,
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Wandbox lua require("packer.load")({'wandbox-vim'}, { cmd = "Wandbox", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Quickrun lua require("packer.load")({'wandbox-vim'}, { cmd = "Quickrun", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file WandboxOptionList lua require("packer.load")({'wandbox-vim'}, { cmd = "WandboxOptionList", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
