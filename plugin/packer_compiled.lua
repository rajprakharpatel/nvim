...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "DAPInstall.nvim", "nvim-dap-ui", "nvim-dap-python", "nvim-dap-virtual-text", "telescope-dap.nvim" },
    commands = { "DAP" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-media-files.nvim", "telescope-symbols.nvim", "telescope-ultisnips.nvim", "telescope-lsp-handlers.nvim", "telescope-dap.nvim" },
    commands = { "Telescope" },
