...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-python", "nvim-dap-ui", "DAPInstall.nvim", "telescope-dap.nvim", "nvim-dap-virtual-text" },
    commands = { "DAP" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-lsp-handlers.nvim", "telescope-media-files.nvim", "telescope-ultisnips.nvim", "telescope-symbols.nvim", "telescope-dap.nvim" },
    commands = { "Telescope" },
