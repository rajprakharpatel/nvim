...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-virtual-text", "nvim-dap-python", "telescope-dap.nvim", "DAPInstall.nvim" },
    commands = { "DAP" },
