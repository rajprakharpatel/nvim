...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-python", "telescope-dap.nvim", "nvim-dap-ui", "nvim-dap-virtual-text", "DAPInstall.nvim" },
    commands = { "DAP" },
