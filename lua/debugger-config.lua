...
map('n', '<space>dbc', ":lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>",
    {noremap = true, silent = true})
map('n', '<space>dbm', ":lua require'dap'.set_breakpoint(nil, nil, vim.fn.input('Log point message: '))<CR>",
    {noremap = true, silent = true})
...
map('n', '<space>de', ':lua require"dap".disconnect();require"dap".close();require"dap".run_last()<CR>',
    {noremap = true, silent = true})
