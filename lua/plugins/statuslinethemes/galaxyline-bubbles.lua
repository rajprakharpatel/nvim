...
gls.left[i] = {
    Space = {
        ...
        highlight = {colors.bg, colors.main_bg},
        condition = function()
            return require('galaxyline.providers.diagnostic').get_diagnostic_error() ~= ''
        end
    }
}
...
gls.left[i] = {
    Space = {
        ...
        highlight = {colors.bg, colors.main_bg},
        condition = function()
            return require('galaxyline.providers.diagnostic').get_diagnostic_warn() ~= ''
        end
    }
}
...
gls.left[i] = {
    Space = {
        ...
        highlight = {colors.bg, colors.main_bg},
        condition = function()
            return require('galaxyline.providers.diagnostic').get_diagnostic_info() ~= ''
        end
    }
}
